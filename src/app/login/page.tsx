    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between items-center p-4 md:p-6 select-none">
      ...
      <main className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-3xl shadow-2xl overflow-hidden my-auto animate-scale-up">
        ...
        <div className="bg-slate-950 p-7 text-center space-y-1.5 relative border-b border-slate-800">
          <div className="w-16 h-16 rounded-[22%] bg-gradient-to-b from-blue-500 via-blue-600 to-indigo-700 flex items-center justify-center text-white mx-auto shadow-2xl shadow-blue-500/30 border border-white/25 mb-3 ring-1 ring-white/10">
            {mode === "mfa_verify" ? (
              <ShieldCheck className="w-8 h-8 text-white stroke-[2.2]" />
            ) : mode === "signup" ? (
              <Building className="w-8 h-8 text-white stroke-[2.2]" />
            ) : (
        ...
        <div className="p-7 space-y-5">
          ...
          {mode === "signin" && (
            <form onSubmit={handleSignInSubmit} className="space-y-4 text-xs">
              ...
              <div>
                <label className="font-bold text-slate-300 block mb-1.5">Target Client Workspace</label>
                <div className="relative">
                  <div className="w-7 h-7 rounded-[7px] bg-gradient-to-b from-purple-500 to-indigo-600 flex items-center justify-center text-white shadow-xs absolute left-2 top-2 pointer-events-none">
                    <Layers className="w-3.5 h-3.5 stroke-[2.2]" />
                  </div>
                  <select
                    value={selectedTenantId}
                    onChange={(e) => setSelectedTenantId(e.target.value)}
                    className="w-full bg-slate-800 border border-slate-700 rounded-2xl pl-11 pr-4 py-2.5 text-slate-100 font-semibold focus:outline-none focus:ring-2 focus:ring-primary appearance-none cursor-pointer"
                  >
              ...
              {/* Email Address */}
              <div>
                <label className="font-bold text-slate-300 block mb-1.5">Corporate Email Address</label>
                <div className="relative">
                  <div className="w-7 h-7 rounded-[7px] bg-gradient-to-b from-blue-500 to-blue-600 flex items-center justify-center text-white shadow-xs absolute left-2 top-2 pointer-events-none">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-800 border border-slate-700 rounded-2xl pl-11 pr-4 py-2.5 text-slate-100 font-semibold focus:outline-none focus:ring-2 focus:ring-primary"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <div className="w-7 h-7 rounded-[7px] bg-gradient-to-b from-amber-400 to-orange-500 flex items-center justify-center text-white shadow-xs absolute left-2 top-2 pointer-events-none">
                    <Key className="w-3.5 h-3.5 stroke-[2.2]" />
                  </div>
                  <input
                    type="password"
                    required
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-extrabold text-xs py-3 rounded-2xl shadow-lg shadow-blue-500/25 transition-all flex items-center justify-center gap-2 cursor-pointer mt-3"
              >
                {isSubmitting ? (
                  <>
            ...
            <form onSubmit={handleMfaSubmit} className="space-y-4 text-xs">
              ...
              <div className="p-3.5 bg-slate-800/90 border border-slate-700 rounded-2xl flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  <div className="w-8 h-8 rounded-[8px] bg-gradient-to-b from-emerald-500 to-teal-600 flex items-center justify-center text-white shadow-xs shrink-0">
                    <ShieldCheck className="w-4 h-4 stroke-[2.2]" />
                  </div>
                  <div>
                    <span className="text-[10px] text-slate-400 block">Authenticator Code (TOTP):</span>
